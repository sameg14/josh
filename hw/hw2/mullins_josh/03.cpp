...
bool is_fibonacci(int number_to_check, int two_previous_number, int previous_number){
	//bool number_in_fib=false;
		if(number_to_check == two_previous_number || number_to_check == previous_number){
		//number_in_fib=true;
		return true;
		}
		int fib_current_number = two_previous_number + previous_number;
...
//	cout << "If the output number is 0, number inputed is not part of the fibonacci sequence."; 		cout << "If the number is a 1, then it is part of the fibonacci sequence " << endl;
//	cout << "The output number you entered is: " << out << endl;
	if(out=1){
...
//	int number_to_check = b;
//	cout << "Checking "  << "... " << (
//		is_fibonacci(number_to_check,two_previous_number,previous_number) ? "valid" : "invalid"
//	) << endl;
