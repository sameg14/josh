...
int main(){
  ...
  display(a,csz,sz);
//display(array,current size, capacity)
...
void display(int* p, int current_size, int cap){
  cout << endl;
  cout << "List Capacity: " << cap << endl;
  cout << "Current number of elements in the list: " << current_size << endl;
  cout << "List contents: ";
